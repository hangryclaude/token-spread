...
226 candidate techniques were adjudicated against that question — **59 pass**, **51 pass on
the provider's word alone**, **68 rejected**, **48 unresolved**. Those four add to 226; a
...
<img src="docs/media/register.gif" alt="The question, then 226 candidates sorting into 59 that pass the bar, 51 that pass on the provider's word alone, 68 rejected and 48 unresolved" width="820">
...
<img src="docs/media/cards/register.jpg" alt="226 techniques adjudicated: 59 pass the bar, 51 pass on the provider's word alone, 68 rejected outright, 48 unresolved and stated as unresolved." width="820">
