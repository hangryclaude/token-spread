...
`358 tests` &nbsp;·&nbsp; `0 bytes written` &nbsp;·&nbsp; `0 prompts read` &nbsp;·&nbsp; `no runtime dependencies` &nbsp;·&nbsp; `bun + TypeScript`
...
371 candidate techniques were adjudicated against that question — **81 pass**, **95 pass on
the provider's word alone**, **135 rejected**, **60 unresolved**. Those four add to 371; a
