...
| 7 | Sonnet 5 intro pricing noted | ~~expires 2026-08-31 — 20 days from today. $2/$10 → $3/$15, a **50% increase**.~~ **Wrong on the day it was written; corrected 2026-08-12.** Anthropic's API release notes dated **2026-08-10** state the $2/$10 pricing *"is now the standard price"* and that the September rise *"will not occur."* This row was published 2026-08-11 against a page that had already been updated. |
